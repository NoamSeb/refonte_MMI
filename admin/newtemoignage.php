...
if (isset($_POST["publier"])) {
    ...
    $promo = $_POST["promo"];
    insertTemoignage($titre, $contenu, $promo);
    ...
    <div class="backoffice">
        ...
        <div class="dashboard">
            <div class="spacebetween">
                ...
                <h2 style="margin:2rem 0">Publier un nouveau témoignage</h2>
                <form class="newarticle" name="article" method="POST" action="newtemoignage.php"><label for="auteur">Auteur</label><input type="text" id="auteur" name="auteur" placeholder="Auteur" require><label for="contenu">Contenu</label><textarea id="contenu" name="contenu" placeholder="Contenu" require></textarea><label for="promo">Promotion</label><input type="text" id="promo" name="promo" placeholder="Promotion" require><input type="submit" id="publier" name="publier" value="Publier"><input type="reset" value="Effacer"></form>
